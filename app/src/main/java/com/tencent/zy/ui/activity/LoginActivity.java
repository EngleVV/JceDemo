...
public class LoginActivity extends BaseActivity implements LoginCallback {
    ...
    @BindView(R.id.et_verfy_code_input)
    EditText evVerifyCodeInput;

    @BindView(R.id.ev_telephone)
    EditText evTelePhone;

    @BindView(R.id.ev_id_card)
    EditText evIDcard;

    @BindView(R.id.ev_home_address)
    EditText evHomeAdd;

    @BindView(R.id.ev_emergency_contact_info_1)
    EditText evEmergencyContactFirst;

    @BindView(R.id.ev_emergency_contact_info_2)
    EditText evEmergencyContactSecond;

    @BindView(R.id.ev_medical_record)
    EditText evMedicalRecord;

    @BindView(R.id.sp_user_category)
